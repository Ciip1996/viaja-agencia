  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{
          background: [
            "radial-gradient(ellipse at 20% 20%, rgba(38, 103, 255, 0.25) 0%, transparent 50%)",
            "radial-gradient(ellipse at 80% 80%, rgba(29, 206, 200, 0.15) 0%, transparent 50%)",
            "radial-gradient(ellipse at 50% 50%, rgba(6, 45, 151, 0.2) 0%, transparent 60%)",
          ].join(", "),
        }}
      />
      <div
      ...
      >
        ...
        >
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 mb-4 overflow-hidden">
            <Image
              src="/logo-viaja.png"
              alt={t("brandName")}
              width={64}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className={cn(
                ...
                "hover:shadow-[0_4px_20px_rgba(38,103,255,0.35)] hover:brightness-110",
