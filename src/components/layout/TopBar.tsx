...
export default function TopBar({ settings = {} }: TopBarProps) {
  ...
  const phone = settings.phone || "477 779 0610";
  ...
  return (
    <div className="bg-primary text-white/90 text-xs sm:text-sm relative z-[60]">
      <div className="container-custom flex items-center justify-between h-9 sm:h-10">
        <div className="flex items-center gap-3 sm:gap-5">
          <a
            href={phoneLink}
            className="flex items-center gap-1.5 hover:text-accent transition-colors duration-200 cursor-pointer"
            aria-label={t("callTo", { phone })}
          >
          ...
          <a
            href={`mailto:${email}`}
            className="flex items-center gap-1.5 hover:text-accent transition-colors duration-200 cursor-pointer"
            aria-label={t("emailTo", { email })}
          >
            <Mail className="w-3 h-3 sm:w-3.5 sm:h-3.5" aria-hidden="true" />
        ...
        <div className="flex items-center gap-1">
          <a
            ...
            className="w-8 h-8 flex items-center justify-center rounded-md hover:bg-white/10 hover:text-accent transition-all duration-200 cursor-pointer"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-8 h-8 flex items-center justify-center rounded-md hover:bg-white/10 hover:text-[#25D366] transition-all duration-200 cursor-pointer"
